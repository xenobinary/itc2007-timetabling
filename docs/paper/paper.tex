...
We performed an evaluation across standard ITC2007 instances using SWI-Prolog on Linux. Runs were configured with a time limit of 30 seconds and maximum 30 randomized restart iterations for the constructive engine.
