...
We performed an evaluation across standard standardized ITC2007 instances using SWI-Prolog 9.x on Linux. Runs were configured with a time limit of 120 seconds and maximum 30 randomized restart iterations for the constructive engine.
