...
\begin{itemize}
\item \textbf{Verification Strategy}: Confirms the system is built correctly against constraints.
\begin{enumerate}[nosep]
...
\item \textbf{Validation Strategy}: Confirms the system meets user/real-world needs.
\begin{enumerate}[nosep]
...
To demonstrate the system's operational capability and interactive terminal UI, the following sequence illustrates a complete solver run for the \texttt{comp03.ctt} instance:
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        img/.style={align=center, inner sep=0pt, font=\small},
        arr/.style={-Latex, ultra thick, draw=blue!60}
    ]
        % Layer 1
        \node[img] (n1) {\includegraphics[width=6.5cm]{images/Step1.png}\\[1mm] Step 1: Main Menu execution};
        
        % Layer 2
        \node[img, below=1cm of n1, xshift=-4cm] (n2) {\includegraphics[width=6.5cm]{images/Step2.png}\\[1mm] Step 2: Instance Selection};
        \node[img, below=1cm of n1, xshift=4cm] (n3) {\includegraphics[width=6.5cm]{images/Step3.png}\\[1mm] Step 3: Instance Summary};
        
        % Layer 3
        \node[img, below=1cm of n2] (n4) {\includegraphics[width=6.5cm]{images/Step4.png}\\[1mm] Step 4: Solver Execution - Greedy};
        \node[img, below=1cm of n3] (n5) {\includegraphics[width=6.5cm]{images/Step5.png}\\[1mm] Step 5: Solver Execution - CLP(FD)};
        
        % Layer 4
        \path (n4.south) -- (n5.south) coordinate[midway] (midway3);
        \node[img, below=1cm of midway3] (n6) {\includegraphics[width=6.5cm]{images/Step6.png}\\[1mm] Step 6: Solution Overview and Timetable Grid};
    ...
    \caption{TUI Program Execution Flow Sequence graph for \texttt{comp03.ctt}}
\end{figure}

\clearpage

\section{Experiments and Results}
We performed an evaluation across standard standardized ITC2007 instances using SWI-Prolog 10.0.2 on Ubuntu 25.10. Runs were configured with a time limit of 120 seconds and maximum 30 randomized restart iterations for the constructive engine.
